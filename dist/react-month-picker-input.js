...
var MonthPickerInput = /** @class */ (function (_super) {
    ...
    function MonthPickerInput(props) {
        ...
        _this.valToMask = function (month, year) {
            var monthNames = [
        ...
        _this.onCalendarChange = function (year, month) {
            var inputValue = _this.valToMask(month, year);
        ...
        if (typeof year == 'number' && typeof month == 'number') {
            inputValue = _this.valToMask(month, year);
        }
        _this.state = {
            year: year,
            month: month,
...
var MonthCalendar = /** @class */ (function (_super) {
    ...
    function MonthCalendar(props) {
        ...
        _this.previous = function () {
            ...
            var startYear = +_this.state.selectedYear - 1;
            _this.selectYear(startYear);
